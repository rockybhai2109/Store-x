        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [  # Top row - 2 buttons
                    ...
                    InlineKeyboardButton("• Support Group •", url="https://t.me/GeniusJunctionX")
                ],
                [  # Center row - 1 button
                    InlineKeyboardButton("• Join Backup •", url="https://t.me/+7R-7p7jVoz9mM2M1")
                ],
                [  # Bottom row - 2 buttons
                    InlineKeyboardButton("• 💎 Premium Courses Free •", url="https://t.me/+eJQiBsIpvrwxMTZl")
