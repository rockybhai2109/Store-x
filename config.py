...
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/GeniusJunctionX")
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "200"))
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://freeimage.host/i/3D374Rf")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://freeimage.host/i/3D374Rf")
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• Powered by @CHOSEN_ONE_x_bot</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
...
OWNER_TAG = os.environ.get("OWNER_TAG", "CHOSEN_ONEx")
